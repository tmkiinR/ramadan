...
public class OccasionsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataList = findViewById(R.id.listView1);
        ...
        RelativeLayout layout = findViewById(R.id.layAdsOccasions);
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog,
                                ...
                                Intent fire = new Intent(
                                        Intent.ACTION_VIEW,
                                        Uri.parse("http://play.google.com/store/apps/details?id=" + getPackageName()));           //com.ramadanazkar.azkarramadan"));
                                startActivity(fire);
