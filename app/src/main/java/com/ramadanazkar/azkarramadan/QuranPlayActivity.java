...
import com.ramadanazkar.azkarramadan.utilities.Utilities;
...
public class QuranPlayActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout layout = findViewById(R.id.layAdsQuranPlayer);
    ...
    public void linking_elements() {
        ...
        txt_Status = findViewById(R.id.quranCurrentDurationLabel);
        current_time = findViewById(R.id.quranCurrentDurationLabel1);
        sound_duration = findViewById(R.id.quranTotalDurationLabel);
        play_image = findViewById(R.id.btnPlay);
