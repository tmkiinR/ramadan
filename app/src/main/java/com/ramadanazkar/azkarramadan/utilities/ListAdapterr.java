package com.ramadanazkar.azkarramadan.utilities;
...
import com.ramadanazkar.azkarramadan.QuranPlayActivity;
import com.ramadanazkar.azkarramadan.R;

import java.util.ArrayList;
import java.util.List;

import static com.ramadanazkar.azkarramadan.MyApplication.getInstance;
...
public class ListAdapterr extends BaseAdapter {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        ImageView QuranListIcon = Item.findViewById(R.id.quranitemicoid);
        ...
        TextView txtTitle = Item.findViewById(R.id.titleid);
